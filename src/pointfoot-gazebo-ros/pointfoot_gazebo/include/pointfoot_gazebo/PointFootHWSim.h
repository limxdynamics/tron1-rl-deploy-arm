...
namespace pointfoot_gazebo
{
  ...
  private:
    ...
    void armCmdCallback(const airbot_msgs::ArmCmdConstPtr& msg);
    ...
    realtime_tools::RealtimeBuffer<airbot_msgs::ArmCmd> armCmdBuffer_;

    double delay_{};  // Delay parameter for the simulation

    ros::Publisher armStatePub_;
    ros::Subscriber armCmdSub_;
